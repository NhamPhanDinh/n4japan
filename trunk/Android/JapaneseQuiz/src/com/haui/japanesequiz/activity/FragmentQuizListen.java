...
public class FragmentQuizListen extends Fragment {
	...
	public static FragmentQuizListen newInstance(int position, boolean loadData) {
		FragmentQuizListen fragment = new FragmentQuizListen();
